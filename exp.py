...
while continueRoutine:
    ...
    if endExpNow or event.getKeys(keyList=["escape",'T','t']):
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif image.status == STARTED and t >= (
                    8.0 + (0.8 - win.monitorFramePeriod * 0.75)):  # most of one frame period left
        ...
        elif image_2.status == STARTED and t >= (
                    9.0 + (0.8 - win.monitorFramePeriod * 0.75)):  # most of one frame period left
        ...
        elif image_3.status == STARTED and t >= (
                    10.0 + (0.8 - win.monitorFramePeriod * 0.75)):  # most of one frame period left
        ...
        elif image_4.status == STARTED and t >= (
                    11.0 + (0.8 - win.monitorFramePeriod * 0.75)):  # most of one frame period left
